  ...
  <div style="padding: 2px; max-width: 580px;">
    ...
    <n-space vertical>
      ...
      <n-steps vertical :current="stepsStatus.current" :status="stepsStatus.currentStatus">
        &lt;!&ndash; <n-step title="Establish blockchain connection">
          <n-space vertical>
        ...
        <n-step title="Compile the smart contract we will interact with">
          <n-space vertical>
            ...
            &lt;!&ndash; <n-tag type="warning" size="small" round :bordered="false">local</n-tag> &ndash;&gt;
        ...
        <n-step title="Check the smart contract state on-chain">
          <n-space vertical>
            &lt;!&ndash; <n-tag type="warning" size="small" round :bordered="false">remote</n-tag> &ndash;&gt;
